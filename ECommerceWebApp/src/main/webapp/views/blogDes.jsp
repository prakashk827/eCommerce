                  ...
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                           ...
                           <li><a href="news-single.html">${blog.title}</a></li>
                        </ul>
                     </li>
                     <li class="nav-item">
					...
					<div class="col-lg-10 mx-auto">
						<div class="blog-details">
							...
							<div class="post-meta text-center">
								<span class="post-author"><a href="#"> Posted By Admin</a></span>
								<span class="post-meta-date"><fmt:formatDate value="${blog.postedDate}" pattern="dd-MM-YYYY" /></span> 
							...
							<div class="post-content post-single">
								...
								<!-- Post comment start-->
								<div class="comments-area" id="comments" style="overflow-y: scroll;">
									<h3 class="comments-heading">${fn:length(blogCommentList)} Comments</h3>
									<ul class="comments-list">
										<c:forEach  items="${blogCommentList}" var="val">
										<li>
											<div class="comment"  style="border:1px solid #e7015e;padding:2%;">
												<img class="comment-avatar float-left" alt="" src="https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg">
												<div class="comment-body">
													<div class="meta-data"><span class="float-right"><a class="comment-reply" href="#"><!-- <i class="fa fa-mail-reply-all"></i> Reply --></a></span>
														<span class="comment-author">${val.firstName} ${val.lastName} </span><span class="comment-date">${val.commentDate}</span>
													</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						...
						<form id="contact-form" class="contact-form" action="/comments/save-blog-comment/" method="post">
							<input type="hidden" name="blogId" value="${blog.id}" />
							<div class="error-container"></div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									<input class="form-control form-control-name" placeholder="First Name" name="firstName" id="firstName" type="text" >
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
									<input class="form-control form-control-name" placeholder="Last Name" name="lastName" id="lastName" type="text" >
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
					...
					<div class="row">
						<div class="col-lg-8 mx-auto">
							...
							<div class="copyright-text text-center">
								<p><a target="_blank" href="https://www.templateshub.net">${blog.title}</a></p>
							</div>
						</div>
					</div>
				</div>
